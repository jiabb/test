...
<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/list" method="post"
    ...
    <ul class="ul-form">
        ...
        <li><label>国家：</label>
            <form:input path="country" htmlEscape="false" maxlength="100" class="input-medium"/>
        </li>
        <li><label>省份：</label>
        ...
        <li class="clearfix"></li>
        <li><label>性别：</label>
            <form:input path="gender" htmlEscape="false" maxlength="1" class="input-medium"/>1:男性，2:女性，0：未知
        </li>
