...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="avatarurl" htmlEscape="false" maxlength="1000" class="input-xlarge "/>最后一个数值代表正方形头像大小（有0、46、64、96、132数值可选，0代表132*132正方形头像），用户没有头像时该项为空。若用户更换头像，原有头像URL将失效。
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="gender" htmlEscape="false" maxlength="1" class="input-xlarge "/>1:男性，2:女性，0：未知
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">用户所在国家：</label>
			<div class="controls">
				<form:input path="country" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">用户的语言：</label>
			<div class="controls">
				<form:input path="language" htmlEscape="false" maxlength="50" class="input-xlarge "/>简体中文为zh_CN
			</div>
		</div>
		<div class="control-group">
